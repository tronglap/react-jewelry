...
const Checkout = () => {
  ...
  // Hàm được gọi khi input được focus
  const handleFocus = () => {
    setIsFocused(true); // Cập nhật trạng thái là đã được focus
  };

  // Hàm được gọi khi input không còn được focus
  const handleBlur = () => {
    setIsFocused(false); // Cập nhật trạng thái là không được focus
  };
